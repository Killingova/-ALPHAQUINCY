...
import { EyeOff, QrCode, CheckCircle } from 'lucide-react';
    ...
    <div className="min-h-screen relative flex flex-col items-center justify-center p-6 bg-white">
      ...
      {currentStep === 'start' && (
        <div className="text-center">
          ...
          <p className="text-xl text-gray-800 leading-relaxed mb-8">
            Bitte beachten Sie die Datenschutzrichtlinien: Stellen Sie sicher,<br/> dass sich keine anderen Personen 
            oder sensible Informationen <br/> im Fokus der Kamera befinden, bevor Sie den QR-Code scannen.
          </p>
      ...
      {currentStep === 'egkRead' && (
        <div className="text-center space-y-4">
          ...
          <button
            onClick={handleCancel}
            className="text-xl px-6 py-2 bg-[#919191] text-white font-semibold rounded hover:opacity-90 mt-6"
          >
            Abbrechen
          </button>
        </div>
      ...
      {currentStep === 'complete' && (
        <div className="text-center space-y-4">
          <div className="my-6 flex flex-col items-center">
            <div className="w-28 h-28 flex items-center justify-center rounded-full bg-gray-100 border border-gray-300">
              <CheckCircle size={56} className="text-gray-600" />
            </div>
          </div>
